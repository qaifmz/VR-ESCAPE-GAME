...
public class TravelingBall : MonoBehaviour {
	...
	void Update () {
        ...
        castShadow = mWorld.ProcessBigLine(GetComponent<TravelingBall>(), mProjectedOnBig.transform);
    ...
    public void ReflectDir(Vector3 n) {  // WATCH OUT!! mDir is point towards n (instead of away!)
